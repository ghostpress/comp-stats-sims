...
## Plot the Results
```{r}
# First, need to clean up a little bit - some values are NaN or 0, some RMSE are Inf, and
...
ggplot(results_clean, aes(x=k, y=RuntimeEst)) +
  ...
  geom_hline(aes(yintercept=RuntimeTrue, color="#6E6A73"), linetype="dashed") +
...
ggplot(q1, aes(x=k, y=Estimate)) +
  ...
  ggtitle("Estimate vs Number of Samples", subtitle="First quantile, p = 1") +
  xlab("Samples") +
  ylab("") +
  theme(axis.line=element_line(color="black"))
